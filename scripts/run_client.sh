...
# Default values
DATA_PATH="${DATA_PATH:-h1_data_auto/fold_cloth_with_both_hands_corrected_delta14/epoch_0/raw/episode_9.hdf5}"
HOST="${HOST:-0.0.0.0}"
PORT="${PORT:-8000}"
PROMPT="${PROMPT:-fold the cloth with both hands, Advantage=True}"

POLICY_CONFIG="${POLICY_CONFIG:-pi05_h1_auto}"
POLICY_DIR="${POLICY_DIR:-checkpoints/pi05_h1_auto/fold_cloth_with_both_hands_corrected_delta14//epoch_0/1499}"
