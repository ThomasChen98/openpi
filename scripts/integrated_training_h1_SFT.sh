#!/bin/bash
# =============================================================================
# Integrated Training Pipeline for H1 Robot - SFT (Supervised Fine-Tuning) Mode
# =============================================================================
#
# This is an ABLATION STUDY version of the training pipeline.
#
# Key Difference from integrated_training_h1.sh:
...
#
# Usage:
#   ./scripts/integrated_training_h1_SFT.sh                    # Use default config
#   ./scripts/integrated_training_h1_SFT.sh --config my.yaml   # Use custom config
#
# Environment Notes:
...
convert_epoch_data() {
    ...
    # No special three-phase conversion needed in SFT mode
    if false; then  # Disable the three-phase conversion block
    ...
    # Disable action chunk advantage computation in SFT mode
    if false; then  # This block is disabled in SFT mode
