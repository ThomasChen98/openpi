...
#
# Environment Notes:
#   - reward_labeling mode uses conda base Python (for Qwen)
#   - action_chunk_advantage mode uses conda base Python (for Qwen)
...
if [ "$LABELING_MODE" = "action_chunk_advantage" ]; then
    ...
    # Structure: examples/h1_control_client/h1_data_lerobot/task_name/epoch_X/data/chunk-000/
...
CONVERT_CMD="$PYTHON_CMD examples/h1_control_client/convert_h1_data_to_lerobot.py \
    --data_dir \"$DATA_DIR\" \
