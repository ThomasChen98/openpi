    ...
    def __init__(self, config_path: str, auto_pause_on_latency: bool = False):
        ...
        if self.include_hands:
            ...
            self.reset_pose = np.array([
                -2.6116014e-01,  2.2527361e-01, -1.5299058e-01, -3.2544231e-01,
                1.2800550e+00,  1.2556803e-01,  1.7745686e-01, -3.6365581e-01,
                -3.0129910e-01,  2.1720469e-01,  6.8551779e-02, -9.8828745e-01,
                -1.9746685e-01, -5.1331449e-01,  9.3900000e+02,  9.9800000e+02,
                1.0000000e+03,  9.9800000e+02,  9.9600000e+02,  9.2400000e+02,
                9.5000000e+02,  9.5000000e+02,  9.5000000e+02,  9.5000000e+02,
                9.5000000e+02,  9.5000000e+02
            ])
        else:
            # Arms only (14 DOF)
            self.reset_pose = np.array([
