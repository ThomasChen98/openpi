    ...
    def __init__(self, config_path: str, auto_pause_on_latency: bool = False):
        ...
        if self.include_hands:
            ...
            self.reset_pose = np.array([
                -5.5590606e-01,  4.0703321e-01, -2.2221339e-01,  3.1435537e-01,
                8.3406210e-01, -1.4026606e-01,  3.0820465e-01, -6.4076090e-01,
                -2.4832582e-01,  2.4879616e-01,  5.3362072e-01, -8.1285036e-01,
                -1.4487994e-01 -5.4027891e-01  9.5920355e+02  9.9011011e+02
                9.5639703e+02,  9.5471783e+02,  9.7566040e+02,  9.0191339e+02,
